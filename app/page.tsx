      ...
      <div className="stage">
        <main className="kok-main" id="main-content">
          <div className="container">
            ...
            <section className="ticket" id="ticket" aria-labelledby="ticket-heading">
              <div className="inner">
                <SectionHeading id="ticket-heading" en="TICKET" ja="チケット情報" />
              </div>
            </section>

            <section className="team" id="players" aria-labelledby="players-heading">
              <PlayersScrollReveal />
              <div className="inner">
                <div className="kok-ticket-players-pin-shell">
                <div className="kok-ticket-players-stage">
                  <div className="kok-ticket-panel kok-section-card" data-label="TICKET" aria-labelledby="ticket-heading">
                    <CardCornerMarks />
                  ...
                  <SectionHeading id="players-heading" en="PLAYERS" ja="出場選手" />
...
function SectionHeading({ id, en, ja }: { id?: string; en: string; ja: string }) {
  return <h2 id={id} className="kok-section-heading"><strong>{en}</strong><span className="jp">{ja}</span></h2>;
}
